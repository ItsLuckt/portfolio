...
import { ExternalLink, ArrowUpRight, FolderGit2, Layers } from "lucide-react";
...
const ProjectCard = ({ project, index, t }: { project: any, index: number, t: any }) => {
  return (
    <motion.div
      ...
      className="bento-card group p-0 flex flex-col md:flex-row gap-0 overflow-hidden mb-8 max-w-6xl mx-auto"
    >
      {/* Content */}
