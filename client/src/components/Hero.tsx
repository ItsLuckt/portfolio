...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative flex flex-col items-center justify-center overflow-x-hidden pt-32 pb-24 min-h-[90vh]"
    >
      ...
      <div className="container mx-auto px-6 relative z-20 grid lg:grid-cols-2 gap-16 lg:gap-8 items-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center lg:justify-start gap-4 w-full sm:w-auto mt-2">
            <Button
              size="lg"
              className="rounded-full text-base px-8 h-14 bg-primary hover:bg-primary/90 text-primary-foreground shadow-[0_0_20px_rgba(147,51,234,0.4)] hover:shadow-[0_0_30px_rgba(147,51,234,0.6)] hover:-translate-y-0.5 transition-all duration-300"
              onClick={() =>
                document
            ...
            <Button
              variant="outline"
              size="lg"
              className="rounded-full text-base px-8 h-14 bg-background/40 backdrop-blur-xl border-border/50 hover:bg-secondary hover:border-border hover:-translate-y-0.5 transition-all duration-300"
