...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-32 bg-background/40 backdrop-blur-md relative border-t border-white/5">
      ...
      <footer className="mt-32 pt-8 border-t border-white/10 text-center text-sm text-muted-foreground flex flex-col md:flex-row justify-between items-center px-6 container mx-auto gap-4 pb-8">
